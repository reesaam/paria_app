...
class SettingsPage extends CoreView<SettingsController> {
  ...
  Widget _widgetGeneral() {
    ...
    Widget leadingCalendar() => Obx(() => Text(controller.selectedCalendar.value.name.capitalizeFirst ?? ''));
    ...
    return SettingsSectionWidget(title: Texts.to.settingsSectionTitleGeneral, widgets: [
      ...
      SettingsSectionItemWidget(text: Texts.to.settingsSectionTitleGeneralCalendar.withDoubleDots, leading: leadingCalendar()),
  ...
  Widget _widgetStorage() => SettingsSectionWidget(title: Texts.to.settingsSectionTitleStorage, widgets: [
        SettingsSectionItemWidget(text: Texts.to.settingsSectionStorageItemEraseContacts, wholeItemFunction: controller.clearContacts),
        SettingsSectionItemWidget(text: Texts.to.settingsSectionStorageItemEraseAccountsRecords, wholeItemFunction: controller.clearAccountsRecords),
        SettingsSectionItemWidget(text: Texts.to.settingsSectionStorageItemEraseAllData, wholeItemFunction: controller.clearContacts),
      ]);
}
